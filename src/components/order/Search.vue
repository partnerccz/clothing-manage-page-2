<template>
  <el-form :model="searchData" ref="formSearch" label-width="90px" class="order-search">
    ...
    <el-form-item label="买家UID" prop="buyuser_uid">
      <el-input v-model="searchData.buyuser_uid" placeholder="请输入买家UID"></el-input>
    </el-form-item>
...
export default {
  ...
  data: function () {
    return {
      searchData: {order_id: '', product_id: '', buyuser_uid: '', order_time: []},
      loading: false
    }
  },
  mounted: function () {
